...
export const PROJECT_STORIES: ProjectStoryData[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        nextProjectCategory: "PORTFOLIO & EDITORIAL",
        nextProjectDescription: "High-performance editorial showcase site built with React, Vite, and Framer Motion.",
        nextProjectTech: ["REACT", "VITE", "TAILWIND", "FRAMER MOTION"],
      },
    ],
  },
  {
    ...
    tagline: "Editorial High-Performance Web Architecture",
    ...
    slides: [
      {
        ...
        type: "hero",
        bgTheme: "warm",
        tagline: "Designed with an editorial aesthetic, smooth physics-driven motion, and interactive story reels.",
        stats: [
          { label: "LIGHTHOUSE SCORE", value: "99/100" },
          { label: "ANIMATION FRAME", value: "60 FPS" },
      ...
      },
      {
        ...
        bgTheme: "dark",
        badge: "DESIGN SYSTEM",
        title: "Editorial Layout & Motion System",
        subtitle: "Minimalist Typography & Micro-interactions",
        description: "Built around modern editorial layout grids, glassmorphism overlays, and dark/light contrast modes.",
        highlights: [
          "Interactive Instagram/Snapchat style story case study viewer",
          "Frosted glass hover card micro-animations",
          "Passive rAF scroll direction detection navbar",
        ],
      },
      {
        id: "portfolio-quote",
        type: "quote",
        bgTheme: "emerald",
        quoteText: "Creating digital experiences where technical engineering and editorial design exist in complete harmony.",
        highlightedPhrase: "technical engineering and editorial design",
        authorOrContext: "Toshit Sai Galam — Developer Ethos",
      },
      {
        id: "portfolio-grid",
        type: "grid",
        bgTheme: "warm",
        title: "Front-End Engineering Stack",
        subtitle: "Modern Web Stack Breakdown",
        columns: [
          {
            heading: "01. CORE LOGIC",
            subheading: "React + Vite",
            items: ["Type-safe TypeScript", "HMR Fast Reload", "Optimized Bundle Splitting"],
            metrics: "Sub-second Load Time",
          },
          {
            heading: "02. STYLING",
            subheading: "Tailwind + CSS Tokens",
            items: ["Custom Ink/Cream theme", "Glassmorphism backdrop-blur", "Dynamic CSS Variables"],
            metrics: "Zero CSS Bloat",
          },
          {
            heading: "03. MOTION",
            subheading: "Framer Motion",
            items: ["GPU-accelerated transforms", "AnimatePresence page exits", "Smooth keyframe transitions"],
            metrics: "60 FPS Render Pipeline",
          },
        ],
      },
      {
        id: "portfolio-readnext",
        type: "readNext",
        bgTheme: "navy",
