  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full flex flex-col xs:flex-row items-start xs:items-center justify-end gap-2 xs:gap-4 font-mono text-xs sm:text-sm text-[#1B1B18]/70 font-medium z-10"
      >
      ...
      >
        ...
        <motion.div
          ...
          className="relative inline-block max-w-full mx-auto mb-6 sm:mb-8 cursor-pointer"
        >
          <h1
          ...
          >
            Let's build something <span className="font-script text-[1.18em] font-normal text-[#1B1B18] px-1 tracking-normal inline-block capitalize">thoughtful</span> together
          </h1>
          <motion.div
            initial={{ scaleX: 0 }}
