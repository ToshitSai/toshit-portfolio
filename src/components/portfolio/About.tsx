...
const AISystemVisual: React.FC = () => {
  ...
  // Nodes for the radar constellation
  const nodes = [
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <svg viewBox="0 0 300 300" className="w-full h-full">
          ...
          <text className="text-[10px] font-mono tracking-[0.24em] fill-[#1F2328]/50 uppercase font-medium">
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="hidden lg:flex lg:col-span-1 flex-col items-center pt-2 text-[#1F2328]/35 font-mono text-xs tracking-widest">
          ...
          <div className="lg:col-span-7 flex flex-col max-w-full lg:max-w-[780px]">
            ...
            <motion.p
              ...
              className="text-[19px] sm:text-[21px] lg:text-[22px] leading-[1.4] tracking-[-0.015em] max-w-[660px] text-left opacity-90"
            >
